...
# single-test
python ./mmdetection/tools/test.py /home/wyz/mmdet/mmdetection/configs/htc_align_r50_fpn_1x_debug.py /home/wyz/mmdet/work_dirs/htc_align_r50_fpn_1x/latest.pth --out results.pkl --eval bbox segm
